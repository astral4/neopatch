//! neopatch_th14: neopatch for Touhou 14.
...
use crate::config::{CONFIG, Th14Config, parse_config, write_manifest_extras};
...
unsafe fn install_hooks() {
    ...
    log::init(&install_dir, core_cfg, host_exe_path.as_deref(), |w| {
        write_manifest_extras(w, th14_cfg)
    });
