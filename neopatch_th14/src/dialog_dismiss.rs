...
const EXIT_FLAG_VA: GameAddr<u32> = unsafe { GameAddr::new(0x004d_6884) };
const EXIT_FLAG_BIT: u32 = 0x0008_0000;

const CREATE_DIALOG_CALL_VA: usize = 0x0046_95c6;
const CREATE_DIALOG_CALL_BYTES: [u8; 6] = [0xff, 0x15, 0x30, 0x12, 0x4b, 0x00];

pub(crate) const DIALOG_PATCHES: &[PatchSite] = &[
    PatchSite::replace(0x0046_959f, &[0x75], &[0xeb], "force resolution dialog"),
    PatchSite::replace(0x0046_95cd, &[0x05], &[0x00], "force dialog hidden"),
    PatchSite::call(
