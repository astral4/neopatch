//! Logic for auto-dismissing th12.8's window-mode startup dialog.
...
const DIALOG_PROC_VA: usize = 0x0045_6190;
const MODE_FULLSCREEN: u8 = 0;
const MODE_WINDOWED: u8 = 1;
const DISPLAY_MODE_VA: GameAddr<u8> = unsafe { GameAddr::new(0x004d_304d) };
const LAUNCH_FLAGS_VA: GameAddr<u32> = unsafe { GameAddr::new(0x004d_59a8) };
const LAUNCH_FLAGS_DIALOG_OK_BITS: u32 = 0x60;
const DIALOG_RET: isize = 6;

const DIALOG_BOX_CALL_VA: usize = 0x0045_3b03;
const DIALOG_BOX_CALL_BYTES: [u8; 6] = [0xff, 0x15, 0xf8, 0xa1, 0x49, 0x00];

pub(crate) const DIALOG_PATCHES: &[PatchSite] = &[
    PatchSite::nop(0x0045_3af2, &[0x74, 0x15], "force dialog gate open"),
    PatchSite::call(
        DIALOG_BOX_CALL_VA,
