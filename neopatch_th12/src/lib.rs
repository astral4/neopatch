//! neopatch_th12: latency reductions, optimizations, and other fixes for Touhou 12.
//!
//! Shipped as `dinput8.dll` next to `th12.exe`.
...
unsafe fn install_hooks() {
    unsafe {
        ...
        // th12's input writer at `fcn.00462ec0` does not read `DIJOYSTATE` offsets
