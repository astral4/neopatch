//! neopatch_th17: neopatch for Touhou 17.
...
use crate::config::{CONFIG, Th17Config, parse_config, write_manifest_extras};
...
unsafe fn install_hooks() {
    ...
    log::init(&install_dir, core_cfg, host_exe_path.as_deref(), |w| {
        write_manifest_extras(w, th17_cfg)
    });
