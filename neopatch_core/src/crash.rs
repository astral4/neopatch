...
use windows_sys::Win32::Foundation::{
    ...
    EXCEPTION_IN_PAGE_ERROR, EXCEPTION_INT_DIVIDE_BY_ZERO, EXCEPTION_INVALID_DISPOSITION,
    EXCEPTION_INVALID_HANDLE, EXCEPTION_NONCONTINUABLE_EXCEPTION, EXCEPTION_PRIV_INSTRUCTION,
    EXCEPTION_SINGLE_STEP, EXCEPTION_STACK_OVERFLOW, GENERIC_WRITE, INVALID_HANDLE_VALUE, NTSTATUS,
    STATUS_FATAL_USER_CALLBACK_EXCEPTION, STATUS_HEAP_CORRUPTION,
    STATUS_INVALID_CRUNTIME_PARAMETER, STATUS_STACK_BUFFER_OVERRUN, STATUS_WX86_BREAKPOINT,
