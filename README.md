...
- Touhou 7 (v1.00b): [`neopatch.ini.example`](neopatch_th07/neopatch.ini.example)
- Touhou 8 (v1.00d): [`neopatch.ini.example`](neopatch_th08/neopatch.ini.example)
- Touhou 9.5 (v1.02a): [`neopatch.ini.example`](neopatch_th095/neopatch.ini.example)
...
- Touhou 12.5 (v1.00a): [`neopatch.ini.example`](neopatch_th125/neopatch.ini.example)
