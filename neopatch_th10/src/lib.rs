//! neopatch_th10: latency reductions, optimizations, and other fixes for Touhou 10.
//!
//! Shipped as `dinput8.dll` next to `th10.exe`.
...
unsafe fn install_hooks() {
    unsafe {
        ...
        // Important: IAT patches should operate on th10.exe's import table, not ours!
        ...
        // th10's input writer at `fcn.004236f0` does not read `DIJOYSTATE` offsets
